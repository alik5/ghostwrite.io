class Letter < ActiveRecord::Base
	...
	store_accessor :properties, :origin, :company, :companydoes, :last_job, :one_word, :position, :achieve, :admire, :common_ground, :thanks, :remember, :their_name, :positive, :industry, :frequency, :pay, :rating, :mobile, :reason, :skill1, :skill2, :background, :reason, :age, :color
